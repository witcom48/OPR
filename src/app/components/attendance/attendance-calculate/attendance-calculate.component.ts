...
export class AttendanceCalculateComponent implements OnInit {
  ...
  title_all: { [key: string]: string } = { EN: "Cal All", TH: "คำนวณทั้งหมด" }
  ...
  all() {
    if (this.selectall) {
      ...
      this.selectedOvertime = true;
      this.selectedDiligence = true;
      this.selectedAllowance = true;
      this.selectedLeave = true;
      this.selectedAbsent = true;
      this.selectedLate = true;
    } else {
      this.selectedSalary = false;
      this.selectedOvertime = false;
      this.selectedDiligence = false;
      this.selectedAllowance = false;
      this.selectedLeave = false;
      this.selectedAbsent = false;
      this.selectedLate = false;
    }
  }
