...
export class YearperiodComponent implements OnInit {
  ...
  get inputStyle(): string {
    return this.yearperiods.year_group;
  }

  set inputStyle(_val: string) {
    this.yearperiods.year_group = _val;
  }
  ngOnInit(): void {
    this.doLoadMenu()
    ...
    { company_code: "PSG", year_id: "1", year_code: "2023", year_name_th: "ปีการลา", year_name_en: "Leave Calendar", year_fromdate: new Date("2022-01-01"), year_todate: new Date("2022-12-31"), year_group: "Leave", created_by: "Admin", modied_by: "admin", created_date: "2022-01-02", modied_date: "2022-01-03", flag: "" },]
  }
