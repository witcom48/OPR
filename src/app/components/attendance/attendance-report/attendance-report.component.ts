...
export class AttendanceReportComponent implements OnInit {
  ...
  title_system_payroll: { [key: string]: string } = { EN: "Reports Attendance", TH: "รายงานการเข้าปฏิบัติงาน" }
  ...
  doLoadMenu() {
    this.itemslike = [{ label: this.title_system_payroll[this.initial_current.Language], routerLink: '/attendance/reports', styleClass: 'activelike' }];
