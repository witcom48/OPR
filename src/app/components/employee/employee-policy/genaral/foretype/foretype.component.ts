...
@Component({
  selector: 'app-foretype',
  templateUrl: './foretype.component.html',
  styleUrls: ['./foretype.component.scss']
})
export class ForetypeComponent implements OnInit {
  ...
  title_initial: { [key: string]: string } = { EN: "Foreigner Type", TH: "ประเภทพนักงานต่างด้าว" };
