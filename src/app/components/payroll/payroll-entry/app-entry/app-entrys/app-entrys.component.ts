...
@Component({
  selector: 'app-app-entrys',
  templateUrl: './app-entrys.component.html',
  styleUrls: ['./app-entrys.component.scss']
})
export class AppEntrysComponent implements OnInit {
    ...
    doBackItem() {
      ...
      doSummaryByEmp() {
        ...
        for (let i = 0; i < this.item_list.length; i++) {
          if (this.item_list[i].item_type === 'DE') {
