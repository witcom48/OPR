...
export class AttcheckinService {
  ...
  public attcheckin_get(timecheckin: attcheckinModel) {
    // console.log('ATT001..');
    let data = {
      device_name: "phone",
      ip: "127.0.0.1",
    ...
    return this.http.post<any>(this.config.ApiAttendanceModule + '/attcheckin_list', data, this.options).toPromise()
      .then((res) => {
  ...
  public attcheckin_record(timecheckins: attcheckinModel[]) {
     var checkin_datas: any = []
    timecheckins.forEach((timecheckins: attcheckinModel) => {
      let datas = {
        company_code: timecheckins.company_code || this.initial_current.CompCode,
        worker_code: timecheckins.worker_code ,
    ...
    return this.http.post<any>(this.config.ApiAttendanceModule + '/attcheckin', data, this.options).toPromise()
      .then((res) => {
        // console.log(res)
        let message = JSON.parse(res);
        return message;
  ...
  public attcheckin_delete(timecheckin: attcheckinModel) {
    // console.log('ATT003..');
    let data = {
      device_name: "phone",
      ip: "127.0.0.1",
    ...
    return this.http.post<any>(this.config.ApiAttendanceModule + '/attcheckin_del', data, this.options).toPromise()
      .then((res) => {
        // console.log(res)
        let message = JSON.parse(res);
        return message;
