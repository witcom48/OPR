    ...
    public planshift_record(ShiftPlan: ShiftplanModels) {
        ...
        ShiftPlan.planschedule.forEach((res: PlanscheduleModels) => {
            let ss = {
                ...
                "planschedule_sun_off": res.planschedule_sun_off ? "Y" : "N",
                "planschedule_mon_off": res.planschedule_mon_off ? "Y" : "N",
                "planschedule_tue_off": res.planschedule_tue_off ? "Y" : "N",
                "planschedule_wed_off": res.planschedule_wed_off ? "Y" : "N",
                "planschedule_thu_off": res.planschedule_thu_off ? "Y" : "N",
                "planschedule_fri_off": res.planschedule_fri_off ? "Y" : "N",
                "planschedule_sat_off": res.planschedule_sat_off ? "Y" : "N",
                "modified_by": "Admin",
                "flag": false
            }
