...
export class LocationService {
    ...
    public location_get() {
        ...
        return this.http
            .post<any>(
                this.config.ApiSystemModule + '/location_list',
                this.basicRequest,
                this.options
            )
            .toPromise()
    ...
    public Location_record(model: LocationModel) {
        ...
        return this.http
            .post<any>(
                this.config.ApiSystemModule + '/location',
                data,
                this.options
            )
            .toPromise()
    ...
    public location_delete(model: LocationModel) {
        ...
        return this.http
            .post<any>(
                this.config.ApiSystemModule + '/location_del',
                data,
                this.options
            )
            .toPromise()
    ...
    public location_import(file: File, file_name: string, file_type: string) {
        ...
        return this.http
            .post<any>(
                this.config.ApiSystemModule + '/doUploadLocation?' + para,
                formData
            )
            .toPromise()
            .then((res) => {
