...
//     public faculty_get() {
//         console.log('FACULTY001..');

//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/faculty_list',
//                 this.basicRequest,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/faculty',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/faculty_del',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/doUploadFaculty?' + para,
//                 formData
//             )
//             .toPromise()
//             .then((res) => {
