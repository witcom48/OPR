...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/institute_list',
//                 this.basicRequest,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/institute',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/institute_del',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/doUploadInstitute?' + para,
//                 formData
//             )
//             .toPromise()
//             .then((res) => {
