...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/major_list',
//                 this.basicRequest,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/major',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/major_del',
//                 data,
//                 this.options
//             )
//             .toPromise()
...
//         return this.http
//             .post<any>(
//                 this.config.ApiSystemModule + '/doUploadMajor?' + para,
//                 formData
//             )
//             .toPromise()
//             .then((res) => {
